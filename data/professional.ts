...
export const defaultProfessionalContent: ProfessionalContent = {
  ...
  proofLinks: [
    ...
    { published: true, sortOrder: 4, label: 'PRODUCTION CMS', title: 'Barnx Portfolio CMS', summary: 'Supabase-backed publishing, media, analytics and administration.', href: '/impact' },
  ],
  experience: [
