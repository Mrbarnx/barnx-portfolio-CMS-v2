...
const proof=[
['SOFTWARE SYSTEMS','Subly','Commerce, product discovery, authentication and dashboard workflows.','/projects/subly'],
['FULL-STACK + AI','Omni-Channel AI Chatbot','Backend, shared lead context, AI conversations and handoff logic.','/projects/omni-channel-ai-chatbot'],
...
['PRODUCTION CMS','Barnx Portfolio CMS','Supabase-backed publishing, media, analytics and administration.','/impact']];
export default async function CapabilitiesPage(){
 const content=await getProfessionalContent();const builds=publishedByOrder(content.capabilities),skills=publishedByOrder(content.skillGroups),services=publishedByOrder(content.services);
 return <main className={styles.page}>
 <section className={styles.hero}><span className="eyebrow">CAPABILITIES / SKILLS & SERVICES</span><h1>Software. AI.<br/>Automation.</h1><p>I build full-stack applications, AI-powered systems, API integrations and business automation around practical product and operational problems.</p><div className={styles.heroActions}><Link className="button black" href="/projects">See project proof <ArrowRight/></Link><a className="button" href="mailto:mrbarnx@gmail.com?subject=Project%20Enquiry">Discuss a project <ArrowRight/></a></div><div className={styles.proofStrip}><div><strong>5+</strong><span>Public case studies</span></div><div><strong>42</strong><span>Healthcare screens built</span></div><div><strong>21</strong><span>SocialFi screens delivered</span></div><div><strong>3+</strong><span>Years building products</span></div></div></section>
