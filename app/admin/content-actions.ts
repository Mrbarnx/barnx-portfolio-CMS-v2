...
export async function saveStudioResourceDraft(data: FormData) {
  return persistStudioResource(data, false);
}

export async function publishStudioResource(data: FormData) {
...
export async function savePromptResourceDraft(data: FormData) {
  return persistPromptResource(data, false);
}
...
async function persistStudioCategory(data: FormData, publish: boolean) {
  ...
  const { supabase, user } = await requireCmsAdmin();
  const payload = { ...parsed.data, id: undefined, href: nullable(data.get('href')), published: publish };
...
export async function saveStudioCategoryDraft(data: FormData) {
  return persistStudioCategory(data, false);
}

export async function publishStudioCategory(data: FormData) {
  return persistStudioCategory(data, true);
}
